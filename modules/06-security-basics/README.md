...
Ready to apply security concepts? Complete the **[Practice Problems](./practice-problems.md)** to build secure applications!

**What you'll implement:**
- Secure user registration with password hashing
- Fix common security vulnerabilities (XSS, SQL injection, CSRF)
- Build secure file upload functionality

These exercises help you build security-first habits.
